!function () {
    ...
    function isDirPath (dirPath, callback) {
    ...
    function isFilePath (file, callback) {
        if (typeof callback !== "function")
            callback = function () {};
    ...
    module.exports = new Class({
        ...
        dumpDatabase: asyncMethod(function (options, callback) {
            process.nextTick(function () {
                ...
                if (!hasbin.sync('mysqldump')) {
                    error = new Error("mysqldump not installed or not in path");
                    error.name = "InvalidBinary";
                ...
                if (!options.host || !options.user || !options.dumpPath || !options.database) {
                    ...
                    isDirPath((extName === '') ? options.dumpPath : dirName, function (exists) {
                        if (!exists) {
        ...
        , restoreDatabase: asyncMethod(function (options, callback) {
            process.nextTick(function () {
                ...
                if (!hasbin.sync('mysql')) {
                    error = new Error("mysql not installed or not in path");
                    error.name = "InvalidBinary";
                    return callback(error);
                }
                ...
                if (!options.user || !options.host || !options.sqlFilePath || !options.database) {
                    ...
                    isFilePath(options.sqlFilePath, function (exists) {
                        if (!exists) {
                        ...
                        command = util.format('mysql %s < %s', params.join(' '), options.sqlFilePath);
                        ...
                        ls = exec(command, function (error, stdout, stderr) {
                            ...
                            callback(null, {
                                stdout: stdout,
                                message: util.format("Db '%s' dump file restored successfully", options.database)
                            });
                        });
                    });
                }
